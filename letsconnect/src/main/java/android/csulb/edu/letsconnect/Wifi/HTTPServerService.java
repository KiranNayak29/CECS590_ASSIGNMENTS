                                ...
                                if (reqJSON != null) {
                                    ...
                                    try {
                                        switch (reqJSON.getInt(Util.KEY_OPERATION)) {
                                            ...
                                            break;
                                            case Util.OPERATION_TYPE_REQUEST_TEXT: {
                                                //send broascast to activities and show them a accept/reject interface
                                                i.putExtra(Util.KEY_INTENT_FILTER_REASON, Util.INTENT_FILTER_REASON_NEW_INCOMING_TEXT);
                                                i.putExtra(Util.KEY_INTENT_FILTER_OTHER_USERNAME, reqJSON.getString(Util.KEY_OTHER_USERNAME));
                                                i.putExtra(Util.KEY_INTENT_FILTER_TEXT,reqJSON.getString(Util.KEY_TEXT));
                                            }
                                            break;
                                            case Util.OPERATION_TYPE_REQUEST_VOICE: {
                                                //send broascast to activities and show them a accept/reject interface
                                                i.putExtra(Util.KEY_INTENT_FILTER_REASON, Util.INTENT_FILTER_REASON_NEW_INCOMING_VOICE);
                                                i.putExtra(Util.KEY_INTENT_FILTER_OTHER_USERNAME, reqJSON.getString(Util.KEY_OTHER_USERNAME));
                                                i.putExtra(Util.KEY_INTENT_FILTER_VOICE,reqJSON.getString(Util.KEY_INTENT_FILTER_VOICE));
                                            }
                                            break;
                                            ...
                                            break;
                                            case Util.OPERATION_TYPE_ACCEPT_TEXT: {
                                                //TODO: Do something
                                                i.putExtra(Util.KEY_INTENT_FILTER_REASON, Util.INTENT_FILTER_REASON_TEXT_ACCEPTED);

                                                Log.d(TAG, "CAllee accepted Text");
                                            }
                                            break;
                                            case Util.OPERATION_TYPE_ACCEPT_VOICE: {
                                                //TODO: Do something
                                                i.putExtra(Util.KEY_INTENT_FILTER_REASON, Util.INTENT_FILTER_REASON_VOICE_ACCEPTED);
