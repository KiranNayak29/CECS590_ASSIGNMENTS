...
public class Util {
    ...
    public static  final int OPERATION_TYPE_REQUEST_TEXT=6;
    public static  final int OPERATION_TYPE_ACCEPT_TEXT=7;
    public static  final int OPERATION_TYPE_REQUEST_VOICE=8;
    public static  final int OPERATION_TYPE_ACCEPT_VOICE=9;
...
//    public static  final int DECISION_TYPE_REJECT=3;
    ...
    public static final String KEY_INTENT_FILTER_TEXT ="filtertext";
    public static final String KEY_INTENT_FILTER_VOICE ="filtervoice";
    ...
    public static final int INTENT_FILTER_REASON_NEW_INCOMING_TEXT =6;
    public static final int INTENT_FILTER_REASON_TEXT_ACCEPTED =7;
    public static final int INTENT_FILTER_REASON_NEW_INCOMING_VOICE =8;
    public static final int INTENT_FILTER_REASON_VOICE_ACCEPTED =9;
